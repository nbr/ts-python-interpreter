define('compiled/src/FileWrapperNode',["require", "exports"], function(require, exports) {
    var FileWrapperNode = (function () {
        ...
        FileWrapperNode.prototype.getUInt32 = function () {
            return this.readNum(this.buffer.readUInt32LE, 4);
        };
        FileWrapperNode.prototype.getUInt8 = function () {
            return this.readNum(this.buffer.readUInt8, 1);
        };
        FileWrapperNode.prototype.getFloat = function () {
            return this.readNum(this.buffer.readFloatLE, 4);
        };
        FileWrapperNode.prototype.getDouble = function () {
            return this.readNum(this.buffer.readDoubleLE, 8);
        };
        FileWrapperNode.prototype.getUtf8 = function (size) {
            var s = this.buffer.toString('utf8', this.offset, this.offset + size);
            this.offset += size;
            return s;
        };
...
define('compiled/src/PycFile',["require", "exports"], function(require, exports) {
    var PycFile = (function () {
        function PycFile(magicno, modtime, codeobj) {
            this.magicno = magicno;
            this.modtime = modtime;
            this.codeobj = codeobj;
        }
        PycFile.prototype.interpret = function () {
            this.codeobj.execute();
        };
        PycFile.prototype.stringify = function () {
...
/**
* Used with permission from @jvilk from
* https://github.com/plasma-umass/doppio
*/
define('compiled/lib/gLong',["require", "exports"], function(require, exports) {
...
define('compiled/src/Tuple',["require", "exports"], function(require, exports) {
    var Tuple = (function () {
        function Tuple(array) {
            this.array = array.slice(0);
        }
        Tuple.prototype.getItem = function (index) {
...
define('compiled/src/List',["require", "exports"], function(require, exports) {
    var List = (function () {
        function List(array) {
            this.array = array.slice(0);
        }
...
define('compiled/src/Dict',["require", "exports"], function(require, exports) {
    var Dict = (function () {
        ...
        Dict.prototype.putItem = function (key, value) {
...
define('compiled/src/Frozenset',["require", "exports"], function(require, exports) {
    var Frozenset = (function () {
        function Frozenset(array) {
            this.array = array.slice(0);
        }
        Frozenset.prototype.getItem = function (index) {
            return this.array[index];
        };
        Frozenset.prototype.getLength = function () {
            return this.array.length;
        };
        return Frozenset;
    })();
...
define('compiled/src/StackMachine',["require", "exports"], function(require, exports) {
...
define('compiled/src/CodeObject',["require", "exports", './StackMachine'], function(require, exports, StackMachine) {
    var CodeObject = (function () {
        //Look into factory pattern?
        function CodeObject(argcount, nlocals, stacksize, flags, code, consts, names, varnames, freevars, cellvars, filename, name, firstlineno, lnotab) {
        ...
        CodeObject.prototype.execute = function () {
        };
        return CodeObject;
    })();
...
define('compiled/src/MarshalParser',["require", "exports", '../lib/gLong', './Tuple', './List', './Dict', './Frozenset', './CodeObject'], function(require, exports, gLong, Tuple, List, Dict, Frozenset, CodeObject) {
    var Constants;
    (function (Constants) {
        Constants[Constants["Null"] = 0] = "Null";
        Constants[Constants["None"] = 1] = "None";
        Constants[Constants["False"] = 2] = "False";
        Constants[Constants["True"] = 3] = "True";
        Constants[Constants["Stopiter"] = 4] = "Stopiter";
        Constants[Constants["Ellipsis"] = 5] = "Ellipsis";
    })(Constants || (Constants = {}));
    var typeParserMap = {
        'O': function typeNull(fw) {
            return 0 /* Null */;
        },
        'N': function typeNone(fw) {
            return 1 /* None */;
        },
        'F': function typeFalse(fw) {
            return 2 /* False */;
        },
        'T': function typeTrue(fw) {
            return 3 /* True */;
        },
        'S': function typeStopiter(fw) {
            return 4 /* Stopiter */;
        },
        '.': function typeEllipsis(fw) {
            return 5 /* Ellipsis */;
        },
        'i': typeInt,
        'I': typeInt64,
    ...
    function typeInt64(fw) {
        //is this reading order of low/high correct
        //with respect to little endian?
        var high = fw.getInt32();
        var low = fw.getInt32();
        return gLong.fromBits(low, high);
    }
    function typeFloat(fw) {
        var size = fw.getUInt8();

        //not sure if the character encoding here is UTF-8
        var s = fw.getUtf8(size);
        return Number(s);
    }
    function typeBinaryFloat(fw) {
        return fw.getDouble();
    }
    function typeComplex(fw) {
        //we still need to find a library to represent complex #
        //see issue #12
        var real = typeFloat(fw);
        var imaginary = typeFloat(fw);
        return undefined;
    }
    function typeBinaryComplex(fw) {
        //we still need to find a library to represent complex #
        //see issue #12
        var real = typeBinaryFloat(fw);
        var imaginary = typeBinaryFloat(fw);
        return undefined;
    }
    function typeLong(fw) {
        //this may not be correct. The blog post is
        //unclear. marshal.c parses TYPE_LONG with
        //r_PyLong on line 568
        return typeInt64(fw);
    }
    function typeString(fw) {
    ...
    //list?
    function typeStringref(fw) {
        return fw.getInt32();
    }
    function typeUnicode(fw) {
        var size = fw.getInt32();
        return fw.getUtf8(size);
    }
    function typeTuple(fw) {
        var count = fw.getInt32();
        return new Tuple(getNextN(count, fw));
    }
    function typeList(fw) {
        var count = fw.getInt32();
        return new List(getNextN(count, fw));
    }
    function typeDict(fw) {
        var object = {};
        var key = exports.parse(fw);
        while (key !== 0 /* Null */) {
            object[key] = exports.parse(fw);
            key = exports.parse(fw);
        }
        return new Dict(object);
    }
    function typeFrozenset(fw) {
        var count = fw.getInt32();
        return new Frozenset(getNextN(count, fw));
    }
    function getNextN(n, fw) {
        var a = new Array();
        for (var i = 0; i < n; i++) {
            a[i] = exports.parse(fw);
        }
        return a;
    }
    function typeCodeObject(fw) {
        var argcount = fw.getInt32();
...
define('compiled/src/PycParser',["require", "exports", './PycFile', './MarshalParser'], function(require, exports, PycFile, MarshalParser) {
    function parse(fw) {
        var magicno = parseMagicNumber(fw);
        var modtime = parseModTimeStamp(fw);
        var codeobj = MarshalParser.parse(fw);
        return new PycFile(magicno, modtime, codeobj);
    }
    exports.parse = parse;
    function parseMagicNumber(fw) {
        var magicno = fw.getInt32();
        return magicno;
    }
    function parseModTimeStamp(fw) {
