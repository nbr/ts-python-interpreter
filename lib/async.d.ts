...
interface AsyncMultipleResultsCallbackNoError<T> { (results: T[]): any; }
...
interface Async {
    ...
    filter<T>(arr: T[], iterator: AsyncIterator<T, boolean>, callback: AsyncMultipleResultsCallbackNoError<T>): any;
